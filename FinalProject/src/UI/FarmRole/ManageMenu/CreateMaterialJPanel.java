 ...
 * @author JANFAN
 */
public class CreateMaterialJPanel extends javax.swing.JPanel {

           /**
            * Creates new form CreateMaterialJPanel
            */
           ...
           public CreateMaterialJPanel(JPanel userProcessContainer, Business business, Farm farm, JSplitPane SplitPanel) {
                      initComponents();
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
               ...
               if (txtName.getText().isEmpty() || txtPrice.getText().isEmpty()) {
                          ...
                          Food food = new Food(txtName.getText(), 0, Double.parseDouble(txtPrice.getText()));
